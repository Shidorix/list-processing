...
Веб-приложение для исследования методов автоматизированной обработки
неструктурированных пользовательских списков. В качестве прикладной области
используются музыкальные трек-листы: они позволяют проверять нормализацию,
транслитерацию, выделение структурированных полей, fuzzy matching и объяснимое
